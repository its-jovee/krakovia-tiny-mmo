...
func join_game(peer_id: int, instance: ServerInstance, player_name: String) -> Dictionary:
	...
	minigame_manager.send_system_message_i18n("minigame_horse_player_joined", {"player": player_name})
...
func start_race() -> void:
	...
	minigame_manager.send_system_message_i18n("minigame_horse_race_begun")
...
func calculate_winnings() -> void:
	...
	# Send system message
	minigame_manager.send_system_message_i18n("minigame_horse_race_winner", {
		"winner": HORSE_NAMES[race_winner],
		"second": HORSE_NAMES[race_second]
	})
...
func _cancel_game() -> void:
	...
	minigame_manager.send_system_message_i18n("system_minigame_cancelled", {"game": "minigame_horse_racing_name"})
	minigame_manager.remove_session(session_id)
